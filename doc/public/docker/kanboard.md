...
# docker-compose
```shell
docker-compose --project-name kanboard --file docker-compose.yaml up --detach --build --remove-orphans
```
```yaml
version: "3.9"
...
services:
  ...
  kanboard:
    ...
    environment:
      DATABASE_URL: mysql://admin:Czy.190815@192.168.2.18:3306/kanboard
