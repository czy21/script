...
engine = create_engine('mysql+pymysql://admin:***REMOVED***@192.168.168.140:3306/spi_local')
mongoClient = MongoClient(host="mongodb://admin:***REMOVED***@192.168.168.140:27017/")
