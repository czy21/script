#!/usr/bin/env python3
createTimeColumn = "create_time  TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) COMMENT '创建时间'"
createUserColumn = "create_user  varchar(36)  NULL COMMENT '创建人'"
updateTimeColumn = "update_time  TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6) COMMENT '更新时间'"
