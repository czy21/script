...
# server
openssl genrsa -out server.key 4096 && openssl req -new -key server.key -out server.csr -config openssl.cnf -nodes -subj "/C=CN/ST=SH/L=SH/O=czy/OU=czy/CN=nas.cluster.com"
